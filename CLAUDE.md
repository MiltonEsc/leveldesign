...
- **UI**: `TilesetGallery` (preview panel) saves/loads tilesets; `LevelStorage` (level sidebar) saves/loads levels; the assets gallery is unchanged but now Supabase-backed.
